...
public class ItemListActivity extends FragmentActivity implements ItemListFragment.Callbacks,SearchView.OnQueryTextListener,OnRefreshListener  {
	...
	static public ShipmentsList sShipmentList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().setIcon(getResources().getDrawable(R.drawable.shipment_gray1));
		getActionBar().setTitle("ABC社　出荷情報");
            ...
            public boolean onNavigationItemSelected(int itemPosition, long itemId) {
            	...
            	asyncTasc.setOnCallBack(new AsyncHttpRequest.CallBackTask() {
            		...
            		public void CallBack(String Result) {
        				...
        				ItemListFragment.sShipmentAdapter = new ShipmentAdapter(getBaseContext(), R.layout.list_item,ids);
        				
            			ItemListFragment ilf = new ItemListFragment();
            			ilf.setUpdatedItemList(getBaseContext());
            			((ItemListFragment) getSupportFragmentManager().findFragmentById(R.id.item_list)).setListAdapter(ItemListFragment.sShipmentAdapter);
            	...
            	ItemListFragment.getShipmentsList();
...
//        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getBaseContext(), android.R.layout.simple_spinner_dropdown_item, actions);
		...
		sShipmentList = new ShipmentsList();
        ...
        ((Button) findViewById(R.id.imageButton3)).setBackgroundColor(getResources().getColor(R.color.yellow));
	...
	public boolean onQueryTextChange(String newText) {
		ItemListFragment.sShipmentAdapter.getFilter().filter(newText);
		return true;
	}
...
//		btn.setBackgroundDrawable(getResources().getDrawable(R.drawable.button_click_style));
		...
		btn.setText(getString(R.string.before_shipment));
...
//		btn.setBackgroundDrawable(getResources().getDrawable(R.drawable.button_click_style));
		btn.setBackgroundColor(Color.TRANSPARENT);
		btn.setOnClickListener(mClickListener);
		btn.setText(getString(R.string.after_shipment));
        btn.setWidth(getResources().getInteger(R.integer.tab_btn_width));
		mi = menu.getItem(2);
		btn = (Button)mi.getActionView();
//		btn.setBackgroundDrawable(getResources().getDrawable(R.drawable.button_click_style));
...
//			v.setBackgroundColor(getResources().getColor(android.R.color.transparent));
			...
			case R.id.imageButton4:
				...
				Intent detailIntent = new Intent(ItemListActivity.this, com.receipt_main.ItemListActivity.class);
...
//			arguments.putString(ItemDetailFragment.ARG_ITEM_ID, ItemListActivity.sShipmentList.shipments[Integer.parseInt(id) - 1].getExternShipmentKey());
//			Log.d("test",ItemListActivity.sShipmentList.shipments[Integer.parseInt(id) - 1].getExternShipmentKey());
...
//			detailIntent.putExtra(ItemDetailFragment.ARG_ITEM_ID, ItemListActivity.sShipmentList.shipments[Integer.parseInt(id) - 1].getExternShipmentKey());
			startActivity(detailIntent);
		}
	}
